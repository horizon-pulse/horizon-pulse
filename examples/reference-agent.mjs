 ...
 * Default: unpaid 402 discovery for all six frozen routes on horizonpulse.dev.
...
/** Frozen catalog — six live paid routes only. */
const ROUTES = [
...
async function main() {
  ...
  console.log(allOk ? "\nDISCOVERY PASS — all six routes return matching 402" : "\nDISCOVERY FAIL — see probes above");
